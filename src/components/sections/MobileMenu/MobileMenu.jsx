    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-y-3">
          ...
          box-border cursor-pointer rounded-full border-2 px-6 py-3"
          >
            Login
          </button>
          <button className="bg-primary-500 border-primary-500 text-primary-1300 primary-glow hover:border-primary-50
           hover:bg-primary-50 primary-glow-hover transition-properties cursor-pointer rounded-full border-2 px-6 py-3"
          >
            Get Started
          </button>
        </div>
