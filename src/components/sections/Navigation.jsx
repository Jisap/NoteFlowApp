  ...
  return (
    ...
    max-lg:px-8 max-md:px-6">
      <a href="/" className="flex items-center gap-x-3 max-md:gap-x-2">
        ...
        />
        <p className="text-xl font-bold tracking-tight max-md:text-lg/8 max-md:tracking-tighter">
          NoteFlow
        </p>
      </a>
      ...
      <div className="flex items-center gap-x-3 max-lg:hidden">
        ...
        <button 
          className="bg-primary-500 border-primary-500 text-primary-1300 hover:border-primary-50
        hover:bg-primary-50 transition-properties cursor-pointer rounded-full border-2 px-8 py-3.5 font-normal primary-glow
        primary-glow-hover text-lg/8 max-xl:px-6 max-xl:py-3 max-xl:text-base/loose"
